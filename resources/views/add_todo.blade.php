            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <h5 class="card-header">
                        <a href="{{ route('todom.index') }}" class="btn btn-sm btn-outline-primary"><i class="fa fa-arrow-left"></i> Назад</a>
                    </h5>
                    ...
                    @if(session()->has('success'))
                        ...
                        <form method="POST" action="{{ route('todom.store') }}">
                            @csrf

                            <div class="form-group row">
                                <label for="title" class="col-form-label text-md-right">Название</label>
