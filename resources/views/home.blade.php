...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Обзор задач') }}</div>

                <h5 class="card-header">
                    <a href="{{ route('todom.create') }}" class ="btn btn-sm btn-outline-primary">Добавить</a>
                </h5>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover table-borderless">
                        <thead>
                        <th score="col">Задачи</th>
                        <th scope="col"></th>
                        </thead>
                        <tbody>

                        @forelse ($todoms as $todo)
                            <tr>
                                @if ($todo->completed)
